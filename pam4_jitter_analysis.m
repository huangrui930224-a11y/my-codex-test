...
%   - 流程严格按用户给定的 15 个步骤实现
    ...
    th02_raw = (Vraw(1) + Vraw(3)) / 2;
    th03_raw = (Vraw(1) + Vraw(4)) / 2;
    th13_raw = (Vraw(2) + Vraw(4)) / 2;
    ...
    for k = 2:numel(symbol_raw)
        ...
        th_ab = choose_threshold(A0, B0, th01_raw, th12_raw, th23_raw, th02_raw, th03_raw, th13_raw);
    ...
    for ui_idx = 2:N_UI
        ...
        th = choose_threshold(A, B, th01, th12, th23, th02, th03, th13);
    ...
    fprintf('阈值: th01=%.6e, th12=%.6e, th23=%.6e, th02=%.6e, th03=%.6e, th13=%.6e (V)\n', ...
        th01, th12, th23, th02, th03, th13);
...
function th = choose_threshold(A, B, th01, th12, th23, th02, th03, th13)
    lo = min(A, B);
    hi = max(A, B);
